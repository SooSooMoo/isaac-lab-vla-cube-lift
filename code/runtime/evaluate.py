...
from smoke_utils import load_policy
        ...
        with torch.inference_mode():
            for step in range(args.horizon):
                ...
                if args.instruction == 'pick up the cube' and lift_streak >= 10:
                    ...
                    break
        np.savez_compressed(out / 'teacher_trace.npz', **{k: np.asarray(v) for k, v in records.items()}, initial_eef=initial_eef, initial_cube=initial_cube, instruction=args.instruction)
